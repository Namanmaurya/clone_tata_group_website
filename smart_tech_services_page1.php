                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="s_t_s_image_card">
                            <img src="assets\Images\s_t_s_pg1.jpeg" alt="icon" class="img-flued">
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="s_t_s_text_card">
                            <h3>Office/Commercial Elevators:</h3>

                            <p>Office and commercial elevators are essential vertical transportation systems
                                specifically designed to move people and goods efficiently within business premises,
                                high-rise office buildings, shopping malls, hotels, hospitals, and other commercial
                                environments. Unlike residential elevators, commercial elevators are built with higher
                                durability, capacity, and safety standards due to the increased frequency of usage and
                                the need to transport larger loads.</p>

                            <h4>Purpose and Usage:</h4>
                            <p>The primary purpose of commercial elevators is to facilitate easy and efficient movement
                                between floors for employees, visitors, and goods. In large office complexes and
                                skyscrapers, elevators are crucial to ensuring smooth building operations, reducing wait
                                times, and providing accessibility for all, including people with disabilities.
                                Elevators in commercial settings are also vital for fire safety, evacuation strategies,
                                and compliance with building regulations.</p>

                            <h4>Types of Commercial Elevators</h4>

                            <p><strong>Passenger Elevators:</strong> These are the most common type used in office
                                ...
                                announcements.</p>
                            <p><strong>Freight Elevators:</strong>These are used to transport goods, equipment, and
                                heavy items. They are larger and more robust than passenger elevators, often with steel
                                interiors and non-slip floors.</p>
                            <p><strong>Service Elevators:</strong>Similar to passenger elevators but designated for
                                staff, maintenance, or delivery personnel, ensuring that public elevators remain clean
                                and available.</p>
                            <p><strong>Dumbwaiters:</strong>Small elevators used in restaurants, hotels, and hospitals
                                to transport food, documents, or small packages between floors.</p>
