                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="s_t_s_image_card">
                            <img src="assets\Images\s_t_s_pg2.jpeg" alt="icon" class="img-flued">
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="s_t_s_text_card">
                            <h3>Residential/Home Elevators:</h3>

                            <p>The primary purpose of a residential elevator is to provide easy access between multiple floors of a house. Whether it’s a two-story family home or a multi-level luxury residence, an elevator offers a practical solution to avoid the physical strain of stairs. They are also a great addition for carrying heavy items like groceries, laundry, or furniture between floors, improving overall convenience and safety.</p>

                            <h4>Types of Residential Elevators</h4>
                            <p><strong>Hydraulic Elevators:</strong> These operate using a piston and fluid system to lift the cab. They are smooth and quiet but require a machine room, making them more suitable for larger homes.</p>
                            <p><strong>Traction Elevators:</strong> Using ropes and counterweights, these elevators are energy-efficient and don’t need a machine room. They’re ideal for houses with limited space.</p>
                            <p><strong>Vacuum (Pneumatic) Elevators:</strong> These modern elevators work using air pressure and require minimal structural changes. They are visually appealing and easy to install but are generally limited in capacity and speed.</p>
                            <p><strong>Chain-Driven or Cable-Driven Elevators:</strong> These are common in residential settings due to their reliable operation and flexibility in installation.</p>
