...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Body    = "Sender Name: <strong>$name</strong><br>Sender Email: <strong>$email</strong><br>Phone Number: <strong>$phone_number</strong><br>location: <strong>$city</strong>";
