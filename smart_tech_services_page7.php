                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="s_t_s_image_card">
                            <img src="assets\Images\s_t_s_pg7.jpeg" alt="icon" class="img-flued">
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="s_t_s_text_card">
                            <h3>Automobile Elevators:</h3>

                            <p>Automobile elevators are specialized vertical transportation systems designed to lift cars or other vehicles between different levels in a building or parking structure. These elevators play a crucial role in space-saving architecture, high-end residential buildings, car showrooms, service garages, and multi-level parking systems. With urban areas facing land shortages and increasing traffic, automobile elevators offer a smart and efficient solution for vehicle mobility in vertical spaces.</p>

                            <h4>Purpose and Importance:</h4>
                            <p>The primary function of automobile elevators is to transport vehicles vertically where traditional ramps are impractical or where space is limited. They eliminate the need for large ramp systems, making them especially useful in basement garages, rooftop parking, and automated parking towers.</p>
                            <ul>
                                <li><strong></strong>Efficient use of space in urban construction</li>
                                <li><strong>Increased vehicle storage</strong> without expanding footprint</li>
                                <li><strong>Enhanced building aesthetics</strong> by removing the need for ramps</li>
                                <li><strong>Secure, private parking</strong> in residential buildings</li>
                            </ul>

                            <h4>Types of Automobile Elevators</h4>

                            <p><strong>Hydraulic Car Lifts:</strong> These are the most common type used in office
                                buildings and public places. They are designed to carry people safely and comfortably
                                and often feature modern interiors, air conditioning, touch screens, and voice
                                announcements.</p>
                            <p><strong>Traction Car Lifts:</strong>These are used to transport goods, equipment, and
                                heavy items. They are larger and more robust than passenger elevators, often with steel
                                interiors and non-slip floors.</p>
                            <p><strong>Automated Parking System Lifts:</strong>Similar to passenger elevators but designated for
                                staff, maintenance, or delivery personnel, ensuring that public elevators remain clean
                                and available.</p>
